...
const CardHome = ({ bnb }) => {
  ...
  const likeHandler = () => {
    fetchLikes(id);
    setAnimate(true);
    setTimeout(() => setAnimate(false), 500); // Remove the animation class after the animation ends
  };
    ...
    <div className="flex flex-col w-64 m-2 rounded-lg overflow-hidden shadow-lg relative bg-stone-50">
      ...
      <div className="absolute top-2 right-2">
        <button
          ...
          onClick={likeHandler}
        >
          {animate ? <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="size-6">
